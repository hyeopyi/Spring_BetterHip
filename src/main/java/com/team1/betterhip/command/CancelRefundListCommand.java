...
public class CancelRefundListCommand implements MyPageCommand {
	...
	public void execute3(HttpServletRequest request, HttpSession session, SqlSession sqlSession, Model model) {
		...
		ArrayList<PurchaseListDto> dtos = dao1.cancelList(USER_ID); 
		...
		ArrayList<PurchaseListDto> dtos1 = dao2.refundList(USER_ID); 

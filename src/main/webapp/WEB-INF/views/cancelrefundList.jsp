...
<!--취소 환불 주문 조회 메인-->
<!--오늘 날짜 가져오는 위한 자바 스크립트립-->
<%
SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
Date date = new Date();
String currentDate = format.format(date);
%>
	<div class="cancelRefundList" style="margin-left: 560px">
		<div class="titlewrap" style="margin-left:280px">	
		<div><h2 align="center" style="display: flex;margin-left: 130px;">나의 쇼핑 내역</h2></div>
		<div><h2 align="center" style="display: flex;margin-left: 130px;">취소/환불 조회</h2></div>
		</div>
		
		<form action="refundQueryList" method="post">
			<table class="refund_list_query">
				<tr>
					<td colspan="2">
					<input type="date" name="startDate" size="20" value="${userInfo.user_joindate_string }"> 
					~ <input type="date" name="endDate" size="20" value="<%=currentDate%>">
		...
		<table border="1">
			<tr>
				...
				<th width="100" height="10" style="text-align: center;">처리상태</th>
			</tr>
			...
			<c:forEach items="${cancelList }" var="dto">
				...
				<tr>
					...
					<td width="150" height="200" rowspan="2"><img src="data:cake_img/png;base64, ${dto.cake_img_base64Image }" width = "100" height="100"></td>
					...
					<td width="100" height="10" rowspan="2" style="text-align: center;">취소완료</td>
				</tr>
				<tr>
		...
		<table border="1">
			...
			<c:forEach items="${refundList }" var="dto">
				...
				<tr>
					...
					<td width="100" height="10" rowspan="2" style="text-align: center;">${dto.purchase_quantity }</td>
					<td width="100" height="10" rowspan="2" style="text-align: center;">${dto.purchase_price_string }원</td>
					<td width="100" height="10" rowspan="2" style="text-align: center;">환불완료</td>
				</tr>
				<tr>
					<td width="250" height="20" style="text-align: center;">
					옵션: ${dto.cake_option }<br> 
